...
def create_color_light_augmentation():
    ...
    return A.Compose([
        ...
        # RGB通道独立偏移 (已注释掉)
        # A.RGBShift(
        #     r_shift_limit=15,  # 红色通道偏移范围[-15,15]
        #     g_shift_limit=15,  # 绿色通道偏移范围[-15,15]
        #     b_shift_limit=15,   # 蓝色通道偏移范围[-15,15]
        #     p=0.5              # 50%概率应用
        # ),
        ...
        # Gamma校正 (已注释掉)
        # A.RandomGamma(
        #     gamma_limit=(80, 120),  # Gamma值范围[80,120] (100表示无变化)
        #     p=0.5                   # 50%概率应用
        # ),
...
if __name__ == "__main__":
    ...
    output_dir = os.path.join(script_dir, "yolo_dataset_final")
